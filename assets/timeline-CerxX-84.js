import{i as e,n as t,o as n}from"./router-BKqFk8oo.js";import{n as r,s as i}from"./index-B1eTZVra.js";import{t as a}from"./nav-Xixn7S4c.js";import{t as o}from"./escape-1QVFIIou.js";import{n as s}from"./storage-N4_Gq-Bz.js";import{t as c}from"./confirm-modal-CDDWdlXn.js";var l=82,u=82,d=1.2,f=.72,p=.024,m=.048,h=.08,g=42e-5,_=160,v=84,y=7,b=[`200,130,106`,`122,158,200`,`106,184,122`,`212,149,106`,`160,130,200`,`180,160,106`];function x(e,{p0:t,p1:n,p2:r}){let i=1-e;return{x:i*i*t.x+2*i*e*n.x+e*e*r.x,y:i*i*t.y+2*i*e*n.y+e*e*r.y}}function S(e,t){let n=(_+t-v)/2,r=u*.55,i=_+24,a=t-v-24;return[{p0:{x:-l,y:n-r},p1:{x:e*.5,y:i},p2:{x:e+l,y:n-r}},{p0:{x:-l,y:n+r},p1:{x:e*.5,y:a},p2:{x:e+l,y:n+r}}]}function C(e,t,n){return e+(t-e)*n}function w(e,t){if(e.inner.innerHTML=``,t.photoUrl){let n=document.createElement(`img`);n.src=t.photoUrl,n.draggable=!1,n.style.cssText=`
